...
const ParentDashboard = () => {
  ...
  const [schoolName, setSchoolName] = useState('ABC School Management System');
    ...
    <Box>
      ...
      <Box sx={{ mt: 6 }}>
        <Paper sx={{ p: 4, borderRadius: 4, elevation: 1 }}>
          <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold' }}>Important Notices from {schoolName}</Typography>
